...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void loginUser() async {
    ...
    if (!isUserFound) {
      setState(() => _isLoading = false); // ← Hide loader on failure
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  // ── Sign In Button with Progress Indicator ──
                  SizedBox(
  ...
  void loginUser() async {
    ...
    for (var user in users) {
      if (user.email == email && user.password == pass) {
        ...
        LocalPersistence.save("login", "true");
        LocalPersistence.saveUser(user.username, user.email, user.password, user.dateOfBirth, user.gender);

        // LocalPersistence.save("username", user.username.toString());
        // LocalPersistence.save("password", user.password.toString());
        // LocalPersistence.save("email", user.email.toString());
        // LocalPersistence.save("dateOfBirth", user.dateOfBirth.toString());
        // LocalPersistence.save("gender", user.gender.toString());
